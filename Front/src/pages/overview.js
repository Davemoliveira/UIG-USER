...
<ul class="flex flex-col md:grid grid-cols-3 gap-5 text-redis-neutral-800 max-w-5xl mx-auto p-10 text-center">
    <li
        ...
        <span className='text-base font-bold'>APPLICATION PORT</span>
        <span class="mb-1 text-indigo-800 font-display text-5xl"><PortDisplay port={port} /></span>
    </li>

    <li
        class="w-full text-sm font-semibold text-slate-900 p-6 bg-white border border-slate-900/10 bg-clip-padding shadow-md shadow-slate-900/5 rounded-lg flex flex-col justify-center">
        <span className='text-base font-bold'>DATABASE PORT</span>
        <span class="mb-1 text-indigo-800 font-display text-5xl"><ServerPort/> </span>
    </li>

    <li
        class="w-full text-sm font-semibold text-slate-900 p-6 bg-white border border-slate-900/10 bg-clip-padding shadow-md shadow-slate-900/5 rounded-lg flex flex-col justify-center">
        <span className='text-base font-bold'>NETWORK STATUS</span>
        <span class="mb-1 text-indigo-800 font-display text-5xl"><NetworkInfoDisplay/></span>
    </li>

    <li
       class="w-full text-sm font-semibold text-slate-900 p-6 bg-white border border-slate-900/10 bg-clip-padding shadow-md shadow-slate-900/5 rounded-lg flex flex-col justify-center">
       <span className='text-base font-bold'>REACT VERSION</span>
       <span class="mb-1 text-indigo-800 font-display text-5xl"><ReactVersion/></span>
    </li>
